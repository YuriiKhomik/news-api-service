...
var _loadMoreBtn = require("./load-more-btn");
...
function onSearch(e) {
    ...
    if (e.target.query.value === "") return alert("Type smth");
    // вмикаємо кнопку
    loadMoreBtn.show();
...
},{"./news-service":"1qRqG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./load-more-btn":"c2vrZ"}],"1qRqG":[function(require,module,exports) {
...
class NewsApiservice {
    ...
    fetchArticles() {
        ...
        return fetch(url, options).then((r)=>r.json()).then((i)=>{
...
},{}],"c2vrZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class loadMoreBtn {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cVgJb","ebWYT"], "ebWYT", "parcelRequire7f71")
